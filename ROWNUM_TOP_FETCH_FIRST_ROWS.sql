...
No Oracle, não temos o comando TOP, com o mesmo resultado/funcionalidade, então podemos usar o comando ROWNUM ou o comando FETCH FIRST ROWS, que funcionará da mesma forma que o comando TOP (MSSQL):
